INSERT INTO spel(spelNaam) VALUES('makkelijk', 'gemiddeld', 'moeilijk');

/* spelborden voor spel "makkelijk" */
INSERT INTO spelbord (spelbordNaam, Spel_spelID) VALUES
('1-1', 1), ('1-2', 1), ('1-3', 1),
('2-1', 2), ('2-2', 2), ('2-3', 2),
('3-1', 3), ('3-2', 3), ('3-3', 3);
...
INSERT INTO veld (positieX, positieY, Spelbord_spelbordID) VALUES
(2,3,1),(3,4,1),(4,2,1);

INSERT INTO doel (positieX, positieY, Spelbord_spelbordID) VALUES
(1,4,1),(3,6,1),(4,1,1),(6,4,1);

INSERT INTO kist (positieX, positieY, Spelbord_spelbordID) values
(3,3,1),(3,5,1),(4,3,1),(5,4,1);

INSERT INTO mannetje (positieX, positieY, Spelbord_spelbordID) VALUES
(4,4,1);
